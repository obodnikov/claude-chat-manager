...
- **Version**: 2.3.0
- **Python**: 3.9+
- **Modules**: 18 source modules (including chat_merger.py, kiro_parser.py, kiro_projects.py)
- **Tests**: 342+ unit tests (100% passing)
...
- **Utilities**:
  - **merge-chats.py** - Intelligent chat file merging (NEW!)
